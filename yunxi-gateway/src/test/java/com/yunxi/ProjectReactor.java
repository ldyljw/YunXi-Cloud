...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.yunxi";
    private static final String ARTIFACT_ID = "Yunxi-Cloud";
    private static final String PACKAGE_NAME = "com.yunxi";
    private static final String TITLE = "云析管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.yunxi";
        String artifactIdNew = "Yunxi-Cloud";
        String packageNameNew = "com.yunxi";
        String titleNew = "云析管理系统";
