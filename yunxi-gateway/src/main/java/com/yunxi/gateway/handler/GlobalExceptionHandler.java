package com.yunxi.gateway.handler;

import com.yunxi.framework.common.pojo.CommonResult;
import com.yunxi.gateway.util.WebFrameworkUtils;
...
import static com.yunxi.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;

/**
 * <p>
 * Gateway 的全局异常处理器，将 Exception 翻译乘 CommonResult + 对应的异常编号
 * 在功能上，和 yunxi-spring-boot-starter-web 的 GlobalExceptionHandler 类是一致的
 * </p>
 *
 * @author lidy
 * @since 2024-04-21
