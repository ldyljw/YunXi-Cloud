package com.yunxi.framework.swagger.config;
...
// 设置为 false 时禁用
@ConditionalOnProperty(prefix = "springdoc.api-docs", name = "enable", havingValue = "true", matchIfMissing = true)
public class YunxiSwaggerAutoConfiguration {
