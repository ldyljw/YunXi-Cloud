package com.yunxi.framework.apilog.core.filter;
...
import com.yunxi.framework.web.core.filter.ApiRequestFilter;
...
import static com.yunxi.framework.apilog.core.interceptor.ApiAccessLogInterceptor.ATTRIBUTE_HANDLER_METHOD;
...
public class ApiAccessLogFilter extends ApiRequestFilter {
    ...
    private static OperateTypeEnum parseOperateLogType(HttpServletRequest request) {
        RequestMethod requestMethod = ArrayUtil.firstMatch(method -> StrUtil.equalsAnyIgnoreCase(method.name(), request.getMethod()), RequestMethod.values());
