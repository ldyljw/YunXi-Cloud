...
import com.yunxi.framework.mq.redis.config.YunxiRedisMQConsumerAutoConfiguration;
import com.yunxi.framework.mq.redis.core.RedisMQTemplate;
import com.yunxi.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.yunxi.framework.websocket.core.listener.WebSocketMessageListener;
import com.yunxi.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.yunxi.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.yunxi.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.yunxi.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.yunxi.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.yunxi.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.yunxi.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.yunxi.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.yunxi.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.yunxi.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.yunxi.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import com.yunxi.framework.websocket.core.session.WebSocketSessionManager;
import com.yunxi.framework.websocket.core.session.WebSocketSessionManagerImpl;
 ...
 * @since 2024-05-06
 */
// before YunxiRedisMQConsumerAutoConfiguration 的原因是，需要保证 RedisWebSocketMessageConsumer 先创建，才能创建 RedisMessageListenerContainer
@AutoConfiguration(before = YunxiRedisMQConsumerAutoConfiguration.class)
@EnableWebSocket // 开启 websocket
@ConditionalOnProperty(prefix = "yunxi.websocket", value = "enable", matchIfMissing = true)
// 允许使用 yunxi.websocket.enable=false 禁用 websocket
@EnableConfigurationProperties(WebSocketProperties.class)
public class YunxiWebSocketAutoConfiguration {
