package com.yunxi.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${yunxi.websocket.sender-rocketmq.topic}",
        consumerGroup = "${yunxi.websocket.sender-rocketmq.consumer-group}",
